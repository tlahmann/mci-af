...
\subsection{Umgebungsvariablen} %hier vielleicht Stuhl, Störungen (also Kommentare der Probanden aufnehmen) etc.
\subsection{Aufgabenergebnisse} %Fehler, Zeiten, pro Aufgaben
\subsection{Selbsteinschätzungen} %oder sowas.. SAM, ..?
