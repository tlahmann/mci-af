...
\todoTob{ich denk die tabelle hier (genauso wie für aufg2 und 3) drüber wäre dann doch überflüssig und das grafische reicht und wenn mans genauer will soll man in deine neue wunderschöne abnormal ultra super geile zusammengefasste tabelle schauen}
...
Wie in Abbildung~\ref{fig:countingTimeHistogram} einsehbar gibt es kaum Unterschiede der einzelnen Gruppen. Man kann erkennen, dass die Alarm Gruppe wieder etwas früher im Schnitt fertig war. \todoSab{hier mehr beschreiben nachdem vllt die tabelle da ist}
...
\todoSab{sam beschreiben}
\todoTob{vllt doch nebeneinander die SAM aber vllt so den Text ändern oder wegmachen dass mans lesen kann}
...
\todoSab{Beschreiben tired after und tired before}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Einschätzung zur Frage 'I felt tired before/after the experiment.'} % caption for whole figure
\end{figure}

\todoSab{transition easy beschreiben}
\todoTob{eins davon raus in Anhang am besten b) und Text darunter wegmachen (kann man ned lesen) -> besser kleine Tabelle hier her wo [1] totally agree [2] agree etc kurz aufgelistet ist; evtl größe aller bilder anpassen}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Einschätzung zur Frage 'The transition from sleeping resting to solving tasks was easy for me.'} % caption for whole figure
\end{figure}

\todoSab{beschreiben comfortabel headset, eingehen auf im anhang ist gegenkontrollfrage}
\todoTob{eins raus (wieder rechtes würd ich sagen) und auch wieder agree blabla text wegnehmen und [1] drunter schreiben oder so}
...
\begin{figure}[H]
	...
	\end{subfigure}
	\caption{Einschätzung zur Frage 'I felt comfortable trying to sleep with a VR head mounted display.'} % caption for whole figure
\end{figure}

\todoSab{waking up beschreiben}
...
\todoSab{premanent wearing beschreiben}
