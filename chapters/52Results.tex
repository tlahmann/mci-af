...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{./_StudyResults/SAMpre}
	\caption{Self-Assessment Manikin Ergebnisse \textbf{vor} der Ruhephase}
	\label{fig:samPre}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{./_StudyResults/SAMpost}
	\caption{Self-Assessment Manikin Ergebnisse \textbf{nach} der Ruhephase}
	\label{fig:samPost}
\end{figure}
