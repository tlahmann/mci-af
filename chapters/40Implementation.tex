...
Um festzustellen, ob Studienteilnehmer eher unruhig waren während der "`Schlafphase"'\todoAll{wording} wird der Vorwärts-Vektor des HMD sowie die Position dieses innerhalb der Virtuellen Umgebung aufgezeichnet.
